...
export const metadata: Metadata = {
  title: "Air Duct Cleaning in Lees Summit, Missouri",
  description: "Professional HVAC duct cleaning services in Lees Summit and surrounding areas. Duct Daddy helps improve air quality, safety, and efficiency for homes and businesses. Book your cleaning today!",
};

export default function LeesSummitPage() {
  return (
    <div>
      <TrackView slug={"Service Area - Lees Summit"} />
      <ServiceHeroSection
        service="Lees Summit's Trusted Air Duct & Dryer Vent Cleaning Experts"
