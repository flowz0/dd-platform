...
export const metadata: Metadata = {
  title: "Air Duct Cleaning in Kansas City, Missouri",
  description: "Professional HVAC duct cleaning services in Kansas City and surrounding areas. Duct Daddy helps improve air quality, safety, and efficiency for homes and businesses. Book your cleaning today!",
};

export default function KansasCityPage() {
  return (
    <div>
      <TrackView slug={"Service Area - Kansas City"} />
      <ServiceHeroSection
        service="Kansas City's Trusted Air Duct & Dryer Vent Cleaning Experts"
