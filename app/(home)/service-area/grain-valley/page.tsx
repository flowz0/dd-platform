...
export const metadata: Metadata = {
  title: "Air Duct Cleaning in Grain Valley, Missouri",
  description: "Professional HVAC duct cleaning services in Grain Valley and surrounding areas. Duct Daddy helps improve air quality, safety, and efficiency for homes and businesses. Book your cleaning today!",
};

export default function GrainValleyPage() {
  return (
    <div>
      <TrackView slug={"Service Area - Grain Valley"} />
      <ServiceHeroSection
        service="Grain Valley Trusted Air Duct & Dryer Vent Cleaning Experts"
