...
export const metadata: Metadata = {
  title: "Air Duct Cleaning in Pleasant Hill, Missouri",
  description: "Professional HVAC duct cleaning services in Pleasant Hill and surrounding areas. Duct Daddy helps improve air quality, safety, and efficiency for homes and businesses. Book your cleaning today!",
};

export default function PleasantHillPage() {
  return (
    <div>
      <TrackView slug={"Service Area - Pleasant Hill"} />
      <ServiceHeroSection
        service="Pleasant Hill's Trusted Air Duct & Dryer Vent Cleaning Experts"
