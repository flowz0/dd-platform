...
export const metadata: Metadata = {
  title: "Air Duct Cleaning in Odessa, Missouri",
  description: "Professional HVAC duct cleaning services in Odessa and surrounding areas. Duct Daddy helps improve air quality, safety, and efficiency for homes and businesses. Book your cleaning today!",
};

export default function OdessaPage() {
  return (
    <div>
      <TrackView slug={"Service Area - Odessa"} />
      <ServiceHeroSection
