...
export const metadata: Metadata = {
  title: "Air Duct Cleaning in Independence, Missouri",
  description: "Professional HVAC duct cleaning services in Independence and surrounding areas. Duct Daddy helps improve air quality, safety, and efficiency for homes and businesses. Book your cleaning today!",
};

export default function IndependencePage() {
  return (
    <div>
      <TrackView slug={"Service Area - Independence"} />
      <ServiceHeroSection
        service="Independence's Trusted Air Duct & Dryer Vent Cleaning Experts"
