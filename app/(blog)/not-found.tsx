      ...
      <div className="pt-32 max-w-7xl px-6 mx-auto sm:pt-48">
        <div className="flex flex-col items-center">
          <h1 className="text-white10 text-h2 font-bold text-center max-w-3xl mt-4 sm:text-h1">
            Blog Not Found But Clean Air is A Click Away
          </h1>
          <p className="text-white25 text-p text-center max-w-2xl mt-4">
            Looks like the blog you&apos;re searching for doesn&apos;t exist. But no worries, Duct Daddy Duct Cleaning is still here with expert HVAC and air duct cleaning services.
          </p>
