...
export default function DeleteBlogModal({
  ...
  return (
    <div
      className="bg-white10/80 backdrop-blur-xs fixed inset-0 z-50 px-6 flex items-center justify-center"
      aria-modal="true"
      role="dialog"
    ...
    >
      <div
        className="bg-white95 rounded-lg shadow shadow-white75 px-6 py-7 md:px-9 md:py-8"
